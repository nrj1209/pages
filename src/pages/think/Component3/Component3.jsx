...
const Component3 = () => {
  return (   
    <div className=' think-Component3-div'>
    {/* <div className='think-Component3-main'> */}
    <div className='think-Component3-top'>
    <img className='think-Component3-img' src={topleft}/>
    <p className=' think-Component3-heading'>Our Story</p>
    <img className='think-Component3-img' src={topright}/>
    </div>
        <div className=' think-Component3-div2'>
          <p className='think-Component3-div2-text'>
        ...
        {/* </div> */}
        <div className=' think-Component3-img-container'>
        <img className='think-Component3-img' src={bottomleft}/>
        <img className='think-Component3-img' src={bottomright}/>
        </div>
    </div>
  )
}
