...
import quanttalogo from '../assets/quanttalogo.svg'
const Component4 = () => {
  return (
    <div className='quantta-Component4-div'>
        <p className='quantta-Component4-heading'>About</p>
      <div className='quantta-Component4-main'>
        <img src={quanttalogo} className='quantta-Component4-img'/>
        <div className='quantta-Component4-content'>
            <p className='quantta-Component4-content-1'>
            ...
            <p className='quantta-Component4-content-2'>
