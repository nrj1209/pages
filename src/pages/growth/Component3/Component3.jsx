...
const Component3 = () => {
  return (   
    <div className=' growth-Component3-div'>
    <div className='growth-Component3-top'>
    <p className=' growth-Component3-heading'>Our Story</p>
    </div>
    <div className='growth-Component3-main'>
    <img src={left} className='growth-Component3-left'/>
        <div className=' growth-Component3-div2'>
          <p className='growth-Component3-div2-text'>
    ...
    <img src={right} className='growth-Component3-right'/>

    </div>  
        {/* </div> */}
        {/* <div className=' growth-Component3-img-container'>
        <img className='growth-Component3-img' src={bottomleft}/>
        <img className='growth-Component3-img' src={bottomright}/>
        </div> */}
    </div>
  )
}
