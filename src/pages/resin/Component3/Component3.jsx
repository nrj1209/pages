...
const Component3 = () => {
  return (   
    <div className=' resin-Component3-div'>
    <p className=' resin-Component3-heading'>How We Started?</p>
        <div className=' resin-Component3-div2'>
          <p className='resin-Component3-div2-text'>
