...
const Component3 = () => {
  return (   
    <div className=' diduce-Component3-div'>
    <p className=' diduce-Component3-heading'>How We Started?</p>
        <div className=' diduce-Component3-div2'>
          <p className='diduce-Component3-div2-text'>
